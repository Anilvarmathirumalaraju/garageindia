...
import whycrabay from "../../assets/Images/car-work-8.jpg";
      ...
      <div className="home-section">
        <div className="home-con">
          <div className="home-content">
            <p>
              Where Every Journey Begins: Your Ultimate Car Service Destination!
            </p>
          </div>
        ...
        <div className="home-services">
          <div className="service-head">
            ...
            <p>
              Your ride's care, our expertise, both tailored true, Car services
              aplenty, all just for you!
            </p>
          </div>
          <div className="service-types-home">
            ...
            >
              <img
                src={ppfceramic}
                alt="Paint protection film and ceramic coating"
              />
            ...
            >
              <img
                src={generalservice}
                alt="General car health check up/others"
              />
        ...
        <div className="why-carbay">
          <div className="why-carbay-content">
            <h1>Why Garage india ?</h1>
            <p>
              Choosing Car Bay for your car service means opting for
              unparalleled expertise, convenience, and dedicated care. Our team
              of seasoned professionals is committed to providing top-notch
              service, ensuring your vehicle receives the attention it deserves.
              With a blend of cutting-edge technology and a customer-centric
              approach, we prioritize your satisfaction, making your car care
              experience seamless and reliable. Trust Car Bay for quality
              service that exceeds expectations, leaving your vehicle in the
              best hands possible.
            </p>
          </div>
          <div className="why-carby-image">
            <h1>Why Garage india ?</h1>
            <img src={whycrabay} alt="whycarbay-image" />
          </div>
        </div>
        {/* how does it works */}
        <div className="how-it-works">
          <div className="how-it-works-head">
            <h1>How Garage india works ?</h1>
          </div>
        ...
        <div className="advantages">
          <div className="advantages-head">
            <h1>Advantages of Garage india</h1>
          </div>
